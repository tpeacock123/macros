...
neutrinoMultiplicityNoPB = neutrinoFile.Get("multiplicity_{}".format(hist_name[0])).GetListOfPrimitives().FindObject("multiplicity_Leading_{}".format(hist_name[0]))
neutrinoMultiplicityNewPB = neutrinoFile.Get("multiplicity_{}".format(hist_name[1])).GetListOfPrimitives().FindObject("multiplicity_Leading_{}".format(hist_name[1]))
neutrinoMultiplicityOldPB = neutrinoFile.Get("multiplicity_{}".format(hist_name[2])).GetListOfPrimitives().FindObject("multiplicity_Leading_{}".format(hist_name[2]))
...
file = ROOT.TFile("2d_multi_neutrino_slices_proton.root", "RECREATE")  
