...
protonMultiplicityNoPB = protonFile.Get("neutron_multiplicity_scale_factor_test2_noscaling").GetListOfPrimitives().FindObject("multiplicityN_Leading_scale_factor_test2_noscaling")
protonMultiplicityNewPB = protonFile.Get("neutron_multiplicity_scale_factor_test5_newbintests").GetListOfPrimitives().FindObject("multiplicityN_Leading_scale_factor_test5_newbintests")
protonMultiplicityOldPB = protonFile.Get("neutron_multiplicity_scale_factor_test2_ogPauliBlock").GetListOfPrimitives().FindObject("multiplicityN_Leading_scale_factor_test2_ogPauliBlock")
...
for i in range(0,13):
    canv_list.append(ROOT.TCanvas("leading_neutron_momentum_multiplicity_{}".format(i), " ", 800, 600))
    grid = gridmaker()
